    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('family', models.ManyToManyField(blank=True, related_name='family_users', to=settings.AUTH_USER_MODEL, verbose_name='выберите участников')),
                ('runner', models.ForeignKey(max_length=12, on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL, verbose_name='Номер участника')),
